...
`$ curl -sL "https://raw.githubusercontent.com//lumeneo/master/scripts/multi_installer.sh" | bash `
...
- `git clone -b master --single-branch https://github.com/lumeneo-network/lumeneo`
- `cd lumeneo`
- `mkdir build && cd $_`
- `cmake ..`
- `make`
...
- `git clone -b master https://github.com/lumeneo-network/lumeneo`
- `cd lumeneo`
- `mkdir build && cd $_`
...
- `MSBuild Lumeneo.sln /p:Configuration=Release /m`
- If all went well, it will complete successfully, and you will find all your binaries in the '..\build\src\Release' directory.
- Additionally, a `.sln` file will have been created in the `build` directory. If you wish to open the project in Visual Studio with this, you can.

#### Thanks
Cryptonote Developers, Bytecoin Developers, Monero Developers, Forknote Project, TurtleCoin Community, Lumeneo Developers
